...
<details>
<summary><b>🔵 Blue Team / SOC Operations</b></summary>
...
<details>
<summary><b>⚙️ Development & Scripting</b></summary>
...
### 🔍 DorkSearch PRO — SaaS Penetration Testing Platform
> `FastAPI` `React` `SQLAlchemy` `Docker` `JWT` `Nginx`
...
> `Python` `VirusTotal API` `Shodan` `AbuseIPDB` `MITRE ATT&CK`
...
> `Wireshark` `Suricata` `Snort` `Cisco Packet Tracer`
...
### 🔐 Unified Steganography Platform
> `Flask` `React` `TypeScript` `RSA-2048` `AES-256` `PBKDF2`
...
> `Cisco Packet Tracer` `VLANs` `ACLs` `Network Segmentation`
...
```
╔══════════════════════════════════════════════════════╗
║  [ CONNECTION TERMINATED — STAY SECURE OUT THERE ]  ║
╚══════════════════════════════════════════════════════╝
```

![Visitor Count](https://komarev.com/ghpvc/?username=WardetWahaj&color=brightgreen&style=for-the-badge&label=PROFILE+VIEWS)
